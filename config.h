...
static const int startwithgaps[]    = {0, 1, 0, 0, 1};	/* 1 means gaps are used by default, this can be customized for each tag */
static const unsigned int gappx[]   = {85, 85, 85, 85, 85};   /* default gap between windows in pixels, this can be customized for each tag */
